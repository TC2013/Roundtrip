...
public class UsbSerialProber {
    private static String TAG = UsbSerialProber.class.getSimpleName();
    ...
    public static ProbeTable getDefaultProbeTable() {
        ...
        probeTable.addDriver(CarelinkDriver.class);
    ...
    public UsbSerialDriver probeDevice(final UsbDevice usbDevice) {
        ...
        Log.d(TAG, String.format("Probing for driver for device 0x%04X, 0x%04X", vendorId, productId));
