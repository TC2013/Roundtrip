...
public class ProbeTable {
    private static String TAG = ProbeTable.class.getSimpleName();
    ...
    public Class<? extends UsbSerialDriver> findDriver(int vendorId, int productId) {
        ...
        Log.d(TAG,String.format("Seeking driver for id pair 0x%04X, 0x%04X",vendorId,productId));
        Class<? extends UsbSerialDriver> rval = mProbeTable.get(pair);
        if (rval == null) {
